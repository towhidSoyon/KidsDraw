...
class MainActivity : AppCompatActivity() {
            ...
            permissions.entries.forEach {
                ...
                if (isGranted){
                    ...
                    if (permissionName==Manifest.permission.READ_EXTERNAL_STORAGE){
                        Toast.makeText(this@MainActivity,"You Just Denied",
                            Toast.LENGTH_LONG).show()
                    }
                }
            }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        drawingView?.setSizeForBush(20.toFloat())

        val linearLayoutPaintColors = findViewById<LinearLayout>(R.id.paintColorsLayout)
        ...
        brush.setOnClickListener{
            showingBrushSizeChoosingDialog()
        }
    ...
    private fun showingBrushSizeChoosingDialog(){
        var brushDialog = Dialog(this)
        brushDialog.setContentView(R.layout.dialog_brush_size)
        brushDialog.setTitle("Brush Size: ")
        val small : ImageButton = brushDialog.findViewById(R.id.ibSmall)
        small.setOnClickListener{
            drawingView?.setSizeForBush(10.toFloat())
            brushDialog.dismiss()
        }

        val medium: ImageButton  = brushDialog.findViewById(R.id.ibMedium)
        medium.setOnClickListener{
            drawingView?.setSizeForBush(20.toFloat())
            brushDialog.dismiss()
        }

        val large : ImageButton = brushDialog.findViewById(R.id.ibLarge)
        large.setOnClickListener{
            drawingView?.setSizeForBush(30.toFloat())
            brushDialog.dismiss()
        }
